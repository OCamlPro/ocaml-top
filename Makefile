...
#	dune exec utils/mkwinapp.exe $(WIN_PFX)/ocaml-top.exe
...
# DO NOT USE; see windows/HOWTO, install Wix on Windows and run the .bat file. You
# will want to test anyway !
